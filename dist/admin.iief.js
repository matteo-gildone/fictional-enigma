(function() {
  ...
  var kb = y$1.extend({ data: null }),
    lb = y$1.extend({ data: null }),
    mb = [9, 13, 27, 32],
  ...
  var Pc = {
    ...
    Qc = y$1.extend({ view: null, detail: null }),
    Rc = {
      Alt: "altKey",
      Control: "ctrlKey",
      Meta: "metaKey",
  ...
  var InputTextComponent =
    ...
    (function(_React$Component) {
      inherits(InputTextComponent, _React$Component);

      function InputTextComponent(props) {
        var _this;

        classCallCheck(this, InputTextComponent);

        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(InputTextComponent).call(this, props)
        );
      ...
      createClass(InputTextComponent, [
        {
          key: "handleChange",
  ...
  var TextAreaComponent =
    /*#__PURE__*/
    (function(_React$Component) {
      inherits(TextAreaComponent, _React$Component);

      function TextAreaComponent(props) {
        var _this;

        classCallCheck(this, TextAreaComponent);

        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(TextAreaComponent).call(this, props)
        );
        _this.handleChange = _this.handleChange.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
  ...
  var InputSwitchComponent =
    /*#__PURE__*/
    (function(_React$Component) {
      inherits(InputSwitchComponent, _React$Component);

      function InputSwitchComponent(props) {
        var _this;

        classCallCheck(this, InputSwitchComponent);

        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(InputSwitchComponent).call(this, props)
        );
        _this.handleChange = _this.handleChange.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
      ...
      createClass(InputSwitchComponent, [
        {
          key: "handleChange",
          value: function handleChange(e) {
            this.props.handleChange(e.target.id, e.target.value);
  ...
  var QuestionComponent =
    /*#__PURE__*/
    (function(_React$Component) {
      inherits(QuestionComponent, _React$Component);

      function QuestionComponent(props) {
        var _this;

        classCallCheck(this, QuestionComponent);

        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(QuestionComponent).call(this, props)
        );
        _this.handleChange = _this.handleChange.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
          ...
          value: function render() {
            return react.createElement(
              ...
              react.createElement(
                ...
                react.createElement(InputSwitchComponent, {
                  label: "Shuffle options",
                  id: "shuffle-".concat(this.props.index),
                  handleChange: this.handleChange
                }),
                react.createElement(InputSwitchComponent, {
                  label: "Enable open text option",
                  id: "moreOption-".concat(this.props.index),
                  handleChange: this.handleChange
                }),
                react.createElement(InputSwitchComponent, {
                  label: "Multiple choice",
                  id: "multiple-".concat(this.props.index),
                  handleChange: this.handleChange
                })
              ),
              react.createElement(InputTextComponent, {
                label: "Question",
                id: "text-".concat(this.props.index),
                value: this.props.question.text,
                handleChange: this.handleChange
              }),
              react.createElement(InputTextComponent, {
                label: "Options",
                id: "options-".concat(this.props.index),
  ...
  var ResultComponent =
    /*#__PURE__*/
    (function(_React$Component) {
      inherits(ResultComponent, _React$Component);

      function ResultComponent(props) {
        var _this;

        classCallCheck(this, ResultComponent);

        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(ResultComponent).call(this, props)
        );
        _this.generateCode = _this.generateCode.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
        return _this;
      }

      createClass(ResultComponent, [
        {
          key: "generateCode",
  ...
  var App =
    ...
    (function(_React$Component) {
      ...
      function App(props) {
        ...
        _this = possibleConstructorReturn(
          this,
          getPrototypeOf(App).call(this, props)
        );
        _this.handleChange = _this.handleChange.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
        _this.handleQuestionChange = _this.handleQuestionChange.bind(
          assertThisInitialized(assertThisInitialized(_this))
        );
        _this.state = {
          vote: false,
      ...
      createClass(App, [
        ...
        },
        {
          ...
          value: function handleChange(id, value) {
            ...
            this.setState(defineProperty({}, id, value), function() {
              _this2.renderPolls();
            });
          }
        },
        {
          ...
          value: function handleQuestionChange(index, id, value) {
            var _this3 = this;

            var list = this.state.questions.slice();
            var key = id.split("-")[0];
          ...
          value: function render() {
            ...
            var questions = this.state.questions.map(function(question, index) {
              return react.createElement(QuestionComponent, {
                ...
                index: index,
                question: question,
                handleChange: _this4.handleQuestionChange
              });
            });
            return react.createElement(
              "div",
                    ...
                    react.createElement(
                      ...
                      react.createElement(
                        ...
                        react.createElement(
                          "legend",
                          {
                            className: "col-form-label col-sm-12 pt-0"
                          },
                          "Poll"
                        ),
                        react.createElement(InputTextComponent, {
